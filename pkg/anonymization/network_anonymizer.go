...
func (anonymizer *NetworkAnonymizer) GetType() AnonymizerType {
...
func (anonymizer *NetworkAnonymizer) AnonymizeData(memoryRecord *record.MemoryRecord) (*record.MemoryRecord, error) {
...
func (anonymizer *NetworkAnonymizer) ObfuscateIP(ipStr string) string {
...
func (anonymizer *NetworkAnonymizer) StoreTranslationTable() *corev1.Secret {
...
func (anonymizer *NetworkAnonymizer) ResetTranslationTable() {
...
func (anonymizer *NetworkAnonymizer) IsEnabled() bool {
...
func (anonymizer *NetworkAnonymizer) readNetworkConfigs() error {
