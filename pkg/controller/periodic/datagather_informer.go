...
type DataGatherInformer interface {
	...
	DatagaGatherStatusChanged() <-chan string
}
...
func (d *dataGatherController) eventHandler() cache.ResourceEventHandler {
	return cache.ResourceEventHandlerFuncs{
		...
		UpdateFunc: func(oldObj, newObj interface{}) {
			...
			// TODO: Helper slice, move it somewhere else?
...
func (d *dataGatherController) DatagaGatherStatusChanged() <-chan string {
